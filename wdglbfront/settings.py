"""
Django settings for wdglbfront project.
...
SECRET_KEY = 'l8xb6s$l^(#fj$b5g9#k_i#us9z+pg3@pj+!d15oadm5p7ufwe'
...
ROOT_URLCONF = 'wdglbfront.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'front', 'dist', 'templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'wdglbfront.wsgi.application'
