...
class AdminDateWidget(forms.DateInput):
    ...
    @property
    def media(self):
        return vendor('datepicker.js', 'datepicker.css', 'xadmin.widget.showdatetime.js')
...
class AdminTimeWidget(forms.TimeInput):
    ...
    @property
    def media(self):
        return vendor('datepicker.js', 'clockpicker.js', 'clockpicker.css', 'xadmin.widget.showdatetime.js')
